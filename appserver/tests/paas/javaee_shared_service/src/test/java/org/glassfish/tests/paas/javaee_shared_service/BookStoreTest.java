...
public class BookStoreTest {
    ...
    public void test() throws Exception {
        ...
        File archive = new File(System.getProperty("basedir")
                + "/target/bookstore2.war"); // TODO :: use mvn apis to get the
        // archive location.
        ...
        try {
            ...
            get("http://"
                    ...
                    + ":"
                    + HTTP_PORT
                    + "/bookstore2/BookStoreServlet?title=Advanced+guide+for+developing+PaaS+components&authors=Shalini+M&price=100%24",
            ...
            if (appName != null) {
                ...
                CommandResult deleteResult = commandRunner.run(
                        "delete-shared-service", "JavaEE_Shared_Service");
