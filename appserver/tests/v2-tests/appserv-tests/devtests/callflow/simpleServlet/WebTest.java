...
public class WebTest {
    ...
    public void doTest() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port
                + contextRoot + "/SimpleServlet", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
    ...
    public void analyseResult(String result) throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port
                +"/dbReader/dbReader?servletName=callflow-simple-servlet", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
