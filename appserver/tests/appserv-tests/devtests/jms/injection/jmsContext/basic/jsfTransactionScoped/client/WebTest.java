...
public class WebTest {
    ...
    private static final String TEST_NAME = "jms-injection-jsf(TransactionScoped)";
    ...
    public void doTest() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port
                          + contextRoot + "/faces/newjsf.xhtml", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
