...
public class WebTest {
    ...
    private static final String TEST_NAME = "jms-injection-jsp(RequestScoped)";
    ...
    public void doTest() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port
                          + contextRoot + "/newJSP.jsp", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
