...
public class WebTest {
    ...
    public void doTest1() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port + contextRoot +
                          "/from1.jsp", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
    ...
    public void doTest2() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port + contextRoot +
                          "/from2.jsp", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
        System.out.println("Connecting to: " + url.toString());
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.connect();
        int responseCode = conn.getResponseCode();
