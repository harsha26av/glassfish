...
/**
 * Unit test for:
 *      Verification that Yasson has been loaded without errors
 */
...
public class YassonTest {
    ...
    private void invoke() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port + contextRoot
                          ...
                          + URLEncoder.encode(PARAMETER), Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
