...
public class WebTest {
    ...
    private static final String TEST_NAME = "servlet-3.0-async-context-dispatch-to-path";
    ...
    public void doTest() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port
            + contextRoot + "/TestServlet?target=DispatchTargetWithPath", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
