...
public class WebTest {
    ...
    private static final String TEST_NAME = "servlet-3.0-servlet-context-set-init-parameter";
    ...
    public void doTest() throws Exception {
        URL url = Urls.create("http://" + host  + ":" + port + contextRoot +
                          "/test", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
