...
/*
 * Unit test for web fragment with ejb lite.
 */
public class WebTest {

    private static SimpleReporterAdapter stat
        = new SimpleReporterAdapter("appserv-tests");
    private static final String TEST_NAME = "servlet-3.0-web-fragment-with-ejb-lite";
    private static final String EXPECTED_RESPONSE = "Hello, Ejb Lite";
