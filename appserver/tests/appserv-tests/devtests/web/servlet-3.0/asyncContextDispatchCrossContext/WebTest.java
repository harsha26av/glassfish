...
public class WebTest {
    ...
    private static final String TEST_NAME = "servlet-3.0-async-cross-context-dispatch";
    ...
    public void doTest() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port +
            "/fromContext/dispatchFrom?myname=myvalue", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
