...
/*
 * Unit test for resource-description, resource-env-description
 * and ejb-reference-description in weblogicDD.
 * Note that service-reference-description is not tested here.
 */
public class WebTest {

    private static SimpleReporterAdapter stat
        = new SimpleReporterAdapter("appserv-tests");
    private static final String TEST_NAME = "wl-reference-descriptor";
    private static final String EXPECTED_RESPONSE = "Hello:my_queue";
