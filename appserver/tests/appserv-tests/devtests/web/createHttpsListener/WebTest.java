...
public class WebTest {
    ...
    public static void main(String args[]) {
        ...
        stat.addDescription("Security enabled listener creation");
...
url = Urls.create("https://" + host  + ":" + 8181 + contextRoot + "/ServletTest", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
            ...
            if (conn instanceof HttpURLConnection) {
               ...
               if (responseCode != 200){
                    ...
                    stat.addStatus("createHttpsListener", stat.PASS);
               }
            }
        }catch(Exception ex){
            stat.addStatus("createHttpsListener", stat.FAIL);
        }
        stat.printSummary("web/createHttpsListener");
