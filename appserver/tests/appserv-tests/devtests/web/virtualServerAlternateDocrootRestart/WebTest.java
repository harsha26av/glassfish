...
public class WebTest {
    ...
    private static final String TEST_NAME
        = "virtual-server-alternate-docroot-restart";
    ...
    private void invoke(String uri, String expected) throws Exception {
        ...
        if (responseCode != Integer.parseInt(expectedResponseCode)) {
            result = false;
            stat.addStatus(TEST_NAME, stat.FAIL);
            throw new Exception("Wrong response code. Expected: " + expectedResponseCode
        ...
        if (line == null) {
            ...
            if (expectedResponseCode.equals("404")) {
                System.out.println("Expected error "+ex+" "+ex.getMessage());
            } else {
                throw ex;
            }
        }
