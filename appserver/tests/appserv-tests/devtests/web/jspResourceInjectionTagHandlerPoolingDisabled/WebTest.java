...
/*
 * Unit test for resource injection into JSP tag handlers, where JSP tag
 * handler pooling has been disabled.
 */
public class WebTest {

    private static final String TEST_NAME =
        "jsp-resource-injection-tag-handler-pooling-disabled";
    ...
    public void doTest() throws Exception {
        ...
        URL url = Urls.create("http://" + host  + ":" + port +
            contextRoot + "/jsp/test.jsp", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
