...
public class WebTest2 {
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            url = Urls.create("http://" + host  + ":" + port + "/" + contextRoot + "/ServletTest", Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS);
            ...
            if (conn instanceof HttpURLConnection) {
               ...
               if (urlConnection.getResponseCode() == 200){
                    ...
                    stat.addStatus("networkListenerDynamicConfig-afterReconf", stat.FAIL);
               }
            }
        }catch(Exception ex){
            stat.addStatus("networkListenerDynamicConfig-afterReconf", stat.FAIL);
        }
        stat.printSummary("web/networkListenerDynamicConfig-afterReconf");
    }
}
