...
public class TestClient {
    ...
    public void doTest(String[] args) {
        ...
        try {
            log("Test: devtests/deployment/ejb30/ear/mdb/webclient");
    ...
    private void log(String message) {
        System.err.println("[ejb30.mdb.webclient.Client]:: " + message);
    }

    private void pass() {
        log("PASSED: devtests/deployment/ejb30/ear/mdb/webclient");
        System.exit(0);
    }

    private void fail() {
        log("FAILED: devtests/deployment/ejb30/ear/mdb/webclient");
        System.exit(-1);
    }
}
