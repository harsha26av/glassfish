...
public class TestClient {
    ...
    public void doTest(String[] args) {
        ...
        try {
            log("Test: devtests/deployment/war/deploydir");
    ...
    private void pass() {
        log("PASSED: devtests/deployment/war/deploydir");
        System.exit(0);
    }

    private void fail() {
        log("FAILED: devtests/deployment/war/deploydir");
        System.exit(-1);
    }
}
